...
from . ubuntu_touch_managerconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('ubuntu-touch-manager')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('ubuntu_touch_manager_lib')
